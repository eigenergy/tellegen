...
impl DcNetwork {
    ...
    pub fn from_network(raw: &BalancedNetwork) -> Result<DcNetwork, String> {
        Self::build(raw, DcConvention::SeriesSusceptance)
    }
    ...
    fn build(raw: &BalancedNetwork, convention: DcConvention) -> Result<DcNetwork, String> {
    ...
    fn build_prepared(
        ...
        let flow_offset = prep.branch_flow_offset();
        ...
        let b = prep.branches.b.iter().map(|value| -value).collect();
        #[cfg(feature = "sensitivity")]
