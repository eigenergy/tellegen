...
pub use contract::{
    functional_gradient, sensitivity, weighted_sensitivity, Axis, Bound, ColMeta, CostTerm,
    Differentiable, ElementId, End, Operand, Parameter, Power, RowMeta, Selector, SensError,
