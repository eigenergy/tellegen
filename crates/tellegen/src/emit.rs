...
use powerio_prob::{DcOpfInstance, Termination};
...
) -> Result<powerio_prob::DcOpfSolution, String> {
...
/// Assemble the portable [`powerio_prob::DcOpfSolution`] for `instance` from
...
pub fn emit_dc_opf_solution(
    ...
    let mut emitted = powerio_prob::DcOpfSolution::new(
        instance,
...
mod tests {
    ...
    fn the_emitted_solution_round_trips_with_marginals_and_bound_multipliers() {
        ...
        let text = stored::write_module(&module).expect("write");
